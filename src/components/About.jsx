...
import AboutImage from "../assets/heros-image.png";
      ...
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          ...
          <div className="flex-1">
            <p className="text-lg first:">
              I am a passionate fronted developer with a focus on building
              modern and responsive web application. With a strong foundation in
              both fronted and designing technology, I strive to create seamless
              and efficient user experiences.
            </p>
            <div className="space-y-4">

                {/* part of html css , react, node progress part */}

              <div className="flex items-center">
                <label htmlFor="htmlanscss" className="w-2/12">
                  HTML & CSS
                </label>
            ...
            <div className="mt-12 flex justify-between text-center">
                {/* this is part of year experiencd happy client etc */}
              <div>
                <h3
